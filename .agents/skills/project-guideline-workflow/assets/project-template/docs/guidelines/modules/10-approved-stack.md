...
| Native mobile client | Flutter | Conditional companion; consumes documented APIs and shares product/security contracts. |
...
| Web theme | shadcn-vue CSS variables | Green primary; light, dark, and system modes. |
...
Awilix is mandatory for generated Nuxt server, worker, scheduler, and realtime
...
The Flutter native profile remains an approved independent companion and is not
an alternate web component system.
